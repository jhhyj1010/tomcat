...
BUILD_VIEW=sybinstrs1571sp305_huiji_vu
RS_VIEW=rs1571sp305_huiji2_vu
...
DROP_DIR=/remote/repqa24/installer/drops/1571/sp${RELEASE}
...
sed -i "s/^\s*DROP_LOCATION=.*/DROP_LOCATION=\/remote\/repqa24\/installer\/drops\/1571\/sp${RELEASE}/g" /view/${BUILD_VIEW}/calm/dub/sybinst/tools/profile
if [ -e ${RMA_SUC_FILE} ]
then
